...
{
    public abstract class AbstractCollectionTests<T, TEnumerator> : AbstractEnumerableTests<T, TEnumerator>
        where TEnumerator : struct, ICollectionEnumerator<T>
    {
        ...
        public void ShouldSlice(int size, uint start, uint length)
        {
            ...
            //Act
            var sliceCollection = collection.Slice(start, length);

            //Assert
            var values = sliceCollection.ToArray();
...
//        }
        ...
        public void ShouldSkipWithVisitor(int size, int skip)
        {
            ...
            collection.Skip(skip).Visit(ref visitor);
        ...
        public void ShouldTakeWithVisitor(int size, int take)
        {
            ...
            collection.Take(take).Visit(ref visitor);
        ...
        public void ShouldReturnIthElement()
        {
            ...
            collection.Count().Should().Be(expected.Length);
