...
namespace StructLinq.Tests
{
    ...
    {
        protected override StructEnumerable<int, ConcatEnumerable<int, ArrayEnumerable<int>, ArrayEnumerable<int>, ArrayStructEnumerator<int>, ArrayStructEnumerator<int>>, ConcatEnumerator<int, ArrayStructEnumerator<int>, ArrayStructEnumerator<int>>> Build(int size)
        {
            var size1 = size / 2;
            var size2 = size - size1;
            var array1 = Enumerable.Range(-1, size1).ToArray().ToStructEnumerable();
            var array2 = Enumerable.Range(-1, size2).ToArray().ToStructEnumerable();
        ...
        {
            var array1 = Enumerable.Range(-1, 15).ToArray();
            var array2 = Enumerable.Range(-1, 10).ToArray();
