...
namespace StructLinq.Benchmark
{
    ...
    public class Union
    {
        ...
        {
            var sum = 0;
            foreach (var i in array1.ToStructEnumerable().Union(array2.ToStructEnumerable()))
            {
                sum += i;
            }
            return sum;
        ...
        public int StructLinqZeroAllocAndComparer()
        {
            ...
            foreach (var i in array1.ToStructEnumerable().Union(array2.ToStructEnumerable(), comparer, x=> x, x=>x))
            {
                sum += i;
            }
            return sum;
