...
{
    public struct IntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer> : IStructEnumerable<T, IntersectEnumerator<T, TEnumerator1, TEnumerator2, TComparer>>
        ...
        where TComparer : IEqualityComparer<T>
    {
        ...
        internal IntersectEnumerable(ref TEnumerable1 enumerable1, ref TEnumerable2 enumerable2, TComparer comparer, int capacity,
        ...
        public IntersectEnumerator<T, TEnumerator1, TEnumerator2, TComparer> GetEnumerator()
        {
            var enum1 = enumerable1.GetEnumerator();
            var enum2 = enumerable2.GetEnumerator();
            return new IntersectEnumerator<T, TEnumerator1, TEnumerator2, TComparer>(ref enum1, ref  enum2, comparer, capacity, bucketPool, slotPool);
        }
