...
namespace StructLinq
{
    public static partial class StructEnumerable
    {
        ...
        {
            return new RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>(ref enumerable, ref enumerable2, comparer, capacity, bucketPool, slotPool); 
        }
        ...
        public static RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>
            ...
            where TEnumerable2 : IRefStructEnumerable<T, TEnumerator2>
        {
            return new RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>(ref enumerable, ref enumerable2, comparer, capacity, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
        ...
        public static RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>
            ...
            where TEnumerable2 : IRefStructEnumerable<T, TEnumerator2>
        {
            return new RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>(ref enumerable, ref enumerable2, comparer, 0, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
        ...
        public static RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>
            ...
            where TEnumerable2 : IRefStructEnumerable<T, TEnumerator2>
        {
            return new RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>(ref enumerable, ref enumerable2, comparer, 0, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
            ...
            where TEnumerable2 : IRefStructEnumerable<T, TEnumerator2>
        {
            ...
            return new RefIntersectEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, StructInEqualityComparer<T>>(ref enumerable, ref enumerable2, equalityComparer, 0, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
        ...
        public static RefIntersectEnumerable<T, IRefStructEnumerable<T, TEnumerator1>, IRefStructEnumerable<T, TEnumerator2>, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>
            ...
            where TEnumerator2 : struct, IRefStructEnumerator<T>
        {
            return new RefIntersectEnumerable<T, IRefStructEnumerable<T, TEnumerator1>, IRefStructEnumerable<T, TEnumerator2>, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>(ref enumerable, ref enumerable2, comparer, 0, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
        ...
        {
            var equalityComparer = InEqualityComparer<T>.Default;
            return new RefIntersectEnumerable<T, IRefStructEnumerable<T, TEnumerator1>, IRefStructEnumerable<T, TEnumerator2>, TEnumerator1, TEnumerator2, StructInEqualityComparer<T>>(ref enumerable, ref enumerable2, equalityComparer, 0, ArrayPool<int>.Shared, ArrayPool<Slot<T>>.Shared);
        }
    }
}