...
namespace StructLinq
{
    public static partial class StructEnumerable
    {
        ...
        public static SelectCollection<TIn, TOut, TEnumerable, TEnumerator, TFunction> Select<TIn, TOut, TEnumerable, TEnumerator, TFunction>(this TEnumerable enumerable, ref TFunction function, 
                                                                                                                                              Func<TEnumerable, IStructCollection<TIn, TEnumerator>> _, Func<TFunction, IFunction<TIn, TOut>> __)
