...
{
    public struct RefUnionEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer> : IRefStructEnumerable<T, RefUnionEnumerator<T, TEnumerator1, TEnumerator2, TComparer>>
        ...
        where TComparer : IInEqualityComparer<T>
    {
        ...
        internal RefUnionEnumerable(ref TEnumerable1 enumerable1, ref TEnumerable2 enumerable2, TComparer comparer, int capacity,
        ...
        public RefUnionEnumerator<T, TEnumerator1, TEnumerator2, TComparer> GetEnumerator()
        {
