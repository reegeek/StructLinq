...
namespace StructLinq
{
    public static partial class StructEnumerable
    {
        ...
        public static RefUnionEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, TComparer>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefUnionEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefUnionEnumerable<T, TEnumerable1, TEnumerable2, TEnumerator1, TEnumerator2, StructInEqualityComparer<T>>
            Union<T, TEnumerable1, TEnumerator1, TEnumerable2, TEnumerator2>(
                this TEnumerable1 enumerable,
                TEnumerable2 enumerable2, 
                Func<TEnumerable1, IRefStructEnumerable<T, TEnumerator1>> _, 
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefUnionEnumerable<T, IRefStructEnumerable<T, TEnumerator1>, IRefStructEnumerable<T, TEnumerator2>, TEnumerator1, TEnumerator2, IInEqualityComparer<T>>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefUnionEnumerable<T, IRefStructEnumerable<T, TEnumerator1>, IRefStructEnumerable<T, TEnumerator2>, TEnumerator1, TEnumerator2, StructInEqualityComparer<T>>
            Union<T, TEnumerator1, TEnumerator2>(
                this IRefStructEnumerable<T, TEnumerator1> enumerable,
                IRefStructEnumerable<T, TEnumerator2> enumerable2)
            where TEnumerator1 : struct, IRefStructEnumerator<T>
