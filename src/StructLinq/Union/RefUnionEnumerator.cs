...
namespace StructLinq.Union
{
        ...
        where TComparer : IInEqualityComparer<T>
    {
        ...
        internal RefUnionEnumerator(ref TEnumerator1 enumerator1, ref TEnumerator2 enumerator2, TComparer comparer, int capacity, ArrayPool<int> bucketPool, ArrayPool<Slot<T>> slotPool)
            : this()
        {
