...
namespace StructLinq
{
    public static partial class StructEnumerable
    {
        ...
        {
            return new(ref enumerable, ref selector, ref comparer, capacity, indexPool, dataPool, keyPool, false);
        }
        ...
        public static OrderByKeyEnumerable<T, TEnumerable, TEnumerator, TSelector, TKey, TComparer> OrderByDescending<T, TEnumerable, TEnumerator, TSelector, TKey, TComparer>(
            ...
            where TComparer : IComparer<TKey>
        {
            return new(ref enumerable, ref selector, ref comparer, capacity, ArrayPool<int>.Shared, ArrayPool<T>.Shared, ArrayPool<TKey>.Shared, false);
        }
        ...
        public static OrderByKeyEnumerable<T, TEnumerable, TEnumerator, TSelector, TKey, TComparer> OrderByDescending<T, TEnumerable, TEnumerator, TSelector, TKey, TComparer>(
            ...
            where TComparer : IComparer<TKey>
        {
            return new(ref enumerable, ref selector, ref comparer, 0, ArrayPool<int>.Shared, ArrayPool<T>.Shared, ArrayPool<TKey>.Shared, false);
        }
            ...
            where TEnumerator : struct, IStructEnumerator<T>
        {
            ...
            return new(ref enumerable, ref structSelector, ref comparer, 0, ArrayPool<int>.Shared, ArrayPool<T>.Shared, ArrayPool<TKey>.Shared, false);
        }
